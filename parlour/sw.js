 ...
 */
var CACHE = 'parlour-v1';   // 23 Aug 2026 — Loop, Bridges and Kakuro; first service worker for this app
var SHELL = [
  './',
  './index.html',
...
self.addEventListener('fetch', function (e) {
  ...
  /* No local data file — everything comes from the shared gist, which the app fetches
     itself and which must never be cached here: a stale body reading would change the calorie
     target silently. api.github.com is left entirely alone by this worker. */
